...
import { LayoutDashboard, TrendingUp, Target, MessageSquareText, Palette, Bot, ChevronLeft, ChevronDown, Activity, Package, Users, ChartBar as FileBarChart, Bell, Settings, Shield, Zap, Brain, Cpu, ChartBar as BarChart3, ChartPie as PieChart, ChartLine as LineChart, Boxes, Truck, Factory, Gauge, TriangleAlert as AlertTriangle, Clock, Globe, UserCheck, ShoppingCart, FileText, Receipt, PenTool, Handshake, LogOut, User, Sparkles, Building2 } from 'lucide-react';
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
