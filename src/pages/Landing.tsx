    ...
    <div style={{ fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, sans-serif", background: '#fafafa', color: '#1a1a1a', overflowX: 'hidden' }}>
      ...
      <section id="home" style={{
        ...
        <div style={{
          ...
          background: 'linear-gradient(135deg, #f5f0fd 0%, #ede9fa 100%)',
        ...
        <div style={{
          ...
          boxShadow: '0 24px 80px rgba(91,33,182,0.08)',
          overflow: 'hidden',
        }} className="hero-card">
          ...
          <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 6 }}>
            {[
              ...
              <div key={i} style={{
                ...
                background: lead.fresh ? '#f7f5fe' : 'transparent',
                border: `1px solid ${lead.fresh ? 'rgba(91,33,182,0.1)' : 'transparent'}`,
              }}>
        ...
        <div style={{ maxWidth: 1160, margin: '0 auto', padding: '80px 28px', width: '100%', position: 'relative' }}>
          <div style={{ maxWidth: 540 }}>
            <div style={{
              ...
              background: '#f5f0fd', border: '1px solid rgba(91,33,182,0.15)',
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 100, alignItems: 'center' }} className="split-grid">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 0, marginBottom: 48 }}>
                {[
                  ...
                  <div key={i} style={{
                    ...
                    <span style={{ fontSize: 12, fontWeight: 700, color: 'rgba(91,33,182,0.3)', paddingTop: 2 }}>{item.n}</span>
                    <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
              {[
                ...
                <div key={i} style={{
                  background: s.dark ? `linear-gradient(135deg, ${R} 0%, ${RDD} 100%)` : '#f3f0fd',
                  borderRadius: 18,
                  padding: '32px 28px',
                }}>
                  ...
                  <div style={{ fontSize: 13, color: s.dark ? 'rgba(255,255,255,0.55)' : 'rgba(91,33,182,0.55)', lineHeight: 1.55 }}>{s.label}</div>
                </div>
              ))}
            </div>
            ...
            {features.map((f, i) => (
              <div key={i} style={{
                ...
                onMouseEnter={e => {
                  ...
                  el.style.boxShadow = '0 8px 40px rgba(91,33,182,0.08)';
                  el.style.borderColor = 'rgba(91,33,182,0.12)';
                }}
                onMouseLeave={e => {
                  const el = e.currentTarget as HTMLDivElement;
              ...
              <div key={i} style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  <div style={{
                    ...
                    background: i === 1 ? 'rgba(255,255,255,0.15)' : '#ede9fa',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12, alignItems: 'start' }} className="three-col">
            {plans.map((plan, i) => (
              <div key={i} style={{
                ...
                position: 'relative',
                boxShadow: plan.highlight ? `0 24px 60px rgba(91,33,182,0.3)` : 'none',
                ...
                {plan.highlight && (
                  <div style={{
                    ...
                    whiteSpace: 'nowrap', boxShadow: '0 2px 12px rgba(91,33,182,0.2)',
                  }}>
                    Most Popular
                  </div>
                )}
            ...
            <div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
                {[
                  ...
                  <div key={i} style={{ background: '#f5f0fd', borderRadius: 14, padding: '20px 18px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                {[
                  ...
                  <div key={i} style={{
                    background: '#f5f0fd', borderRadius: 14, padding: '22px 18px',
      ...
      {/* FOOTER */}
      <footer style={{ background: FOOT, borderTop: `1px solid rgba(91,33,182,0.15)`, padding: '56px 28px 28px' }}>
        <div style={{ maxWidth: 1160, margin: '0 auto' }}>
