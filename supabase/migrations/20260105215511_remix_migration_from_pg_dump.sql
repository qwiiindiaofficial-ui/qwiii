...
CREATE TABLE public.user_roles (
    ...
    allowed_pages text[] DEFAULT ARRAY['/'::text, '/settings'::text],
    created_at timestamp with time zone DEFAULT now() NOT NULL,
...
CREATE POLICY "Admins can update settings" ON public.app_settings FOR UPDATE USING (public.is_admin(auth.uid()));


--
-- Name: user_activities Admins can view all activities; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Admins can view all activities" ON public.user_activities FOR SELECT USING (public.is_admin(auth.uid()));
...
--
-- Name: user_activities Authenticated users can log activities; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Authenticated users can log activities" ON public.user_activities FOR INSERT WITH CHECK ((auth.uid() IS NOT NULL));
